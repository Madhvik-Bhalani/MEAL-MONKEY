...
function Changepass() {
    ...
    const {refpass,refclosepass,refopass}=refcon
                ...
                <div className="offcanvas-body">
                    <form method='POST' onSubmit={subHandler}>
                        ...
                        <div className="mb-3">
                            ...
                            <input type="text" className="form-control" id="opass" aria-describedby="emailHelp" name="opass" required onChange={changeHandler} value={pass.opass} ref={refopass}/>

                        </div>
                        <div className="mb-3">
                            <label htmlFor="npass" className="form-label text-capitalize">New Password</label>
                            <input type="password" className="form-control" id="npass" name="npass" required onChange={changeHandler} value={pass.npass} ref={refcon.refnpass}/>
                        </div>
                        <div className="mb-3">
                            <label htmlFor="rpass" className="form-label text-capitalize">Re-Type Password</label>
                            <input type="password" className="form-control" id="rpass" name="rpass" required onChange={changeHandler} value={pass.rpass} ref={refcon.refrpass}/>
                        </div>
